...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: "/137103134master1200.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
    position: "center", // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
    credit: {
      enable: true, // Display the credit text of the banner image
      text: "Pixiv @void_0", // Credit text to be displayed
      url: "https://www.pixiv.net/artworks/137103134", // (Optional) URL link to the original artwork or artist's page
    },
  },
  toc: {
...
export const profileConfig: ProfileConfig = {
  ...
  links: [
		...
		},*/
    {
      ...
      url: "https://github.com/orgs/Sofia-Luceat-Project/repositories",
    },
  ],
};
